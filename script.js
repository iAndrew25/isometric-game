...
const 
	...
	MAP_HEIGHT = 20,
	MAP = [
		11, 11, 11, 11, 11, 11, 11, 30, 23, 20, 20, 20, 20, 20, 20, 21, 30, 11, 11, 11,
		11, 11, 11, 11, 11, 11, 11, 30, 23, 20, 20, 20, 20, 20, 37, 33, 30, 11, 11, 11,
		11, 11, 11, 11, 11, 11, 11, 30, 32, 36, 37, 24, 24, 24, 33, 30, 30, 11, 11, 11,
		11, 11, 11, 11, 11, 11, 11, 11, 30, 32, 33, 30, 30, 30, 30, 30, 11, 11, 11, 11,
		11, 11, 11, 11, 11, 11, 11, 11, 11, 30, 30, 30, 11, 11, 11, 11, 11, 11, 11, 11,
...
const isCollision = (nextX, nextY) => {
	return nextX < 0 || nextY < 0 || nextX > MAP_WIDTH - 1 || nextY > MAP_HEIGHT - 1 || MAP[getIndex(nextX, nextY)] !== 11;
}

const drawPlayer = (ctx, player, x, y) => ctx.drawImage(img, TILES[10].x, TILES[10].y, TILE_WIDTH, TILE_HEIGHT, x, y, TILE_WIDTH, TILE_HEIGHT);
